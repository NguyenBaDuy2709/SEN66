...
C_SRCS += \
../Core/App/Libraries/GNSS/GNSS.c 

C_DEPS += \
./Core/App/Libraries/GNSS/GNSS.d 

OBJS += \
./Core/App/Libraries/GNSS/GNSS.o 


# Each subdirectory must supply rules for building sources it contributes
Core/App/Libraries/GNSS/%.o Core/App/Libraries/GNSS/%.su Core/App/Libraries/GNSS/%.cyclo: ../Core/App/Libraries/GNSS/%.c Core/App/Libraries/GNSS/subdir.mk
...
clean: clean-Core-2f-App-2f-Libraries-2f-GNSS

clean-Core-2f-App-2f-Libraries-2f-GNSS:
	-$(RM) ./Core/App/Libraries/GNSS/GNSS.cyclo ./Core/App/Libraries/GNSS/GNSS.d ./Core/App/Libraries/GNSS/GNSS.o ./Core/App/Libraries/GNSS/GNSS.su

.PHONY: clean-Core-2f-App-2f-Libraries-2f-GNSS
